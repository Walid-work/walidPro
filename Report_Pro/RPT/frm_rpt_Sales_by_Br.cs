    ...
    public partial class frm_rpt_Sales_by_Br : Form
    {
        ...
        private void btn_Report_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                "%' and A.group_code  between (CASE WHEN '" + Uc_Group.ID.Text.Length + "' >3  then  '" +Uc_Group.ID.Text + "' else '" + Uc_Group.ID.Text + "'+'0' end) and (CASE WHEN '" + Uc_Group1.ID.Text.Length + "' >3   then  '" + Uc_Group1.ID.Text + "' else  '" + Uc_Group1.ID.Text + "'+'z' end) and D.Item_No like '" + Items.ID.Text +
        ...
        private void choises()
        {
            ...
            if (chB.Checked == true) { Z = "B"; } else { Z = "Y"; }
            if (chN.Checked == true) { X = "N"; } else { X = "Y"; }
...
DataSet ds = new DataSet();
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            " and C.acc_no not like case when '" + SC + "' = 3 then'123998%' else '' end " +
            " and isnull(A.Category,'') in('" + R + "','" + F + "','" + C + "','" + P + "','" + S + "','" + Z + "','" + X + "','" + B + "','" + N + "') " +
            " and ISNULL(A.group_code,'')  between (CASE WHEN '" + Uc_Group.ID.Text.Length + "' >3  then  '" + Uc_Group.ID.Text + "' else '" + Uc_Group.ID.Text + "'+'0' end) and (CASE WHEN '" + Uc_Group1.ID.Text.Length + "' >3   then  '" + Uc_Group1.ID.Text + "' else  '" + Uc_Group1.ID.Text + "'+'z' end) and KM_CODE_ACC like case when '" + str_t + "'= 3 then '3%' else '%' end  and KM_CODE_ACC not like case when '" + str_t + "'= 2 then '3%' else '' end " +
