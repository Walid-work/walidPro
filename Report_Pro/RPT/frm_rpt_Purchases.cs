...
namespace Report_Pro.RPT
{
    public partial class frm_rpt_Purchases : Form
    {
        ...
        "%'	and A.Item_No  like '"+UcItem.ID.Text +
        "%' and isnull(C.Po_no,'') like case when '"+txtPoNo.Text.Trim()+"'='' then '%' else '"+txtPoNo.Text+"' end group by H.Branch_code,H.branch_name");
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                "%' and isnull(C.LC_ACC_NO,'') like '" + Lc_Acc.ID.Text +
                "%'	and A.Item_No  like '" + UcItem.ID.Text +
                "%' and isnull(C.Po_no,'') like case when '" + txtPoNo.Text.Trim() + "'='' then '%' else '" + txtPoNo.Text + "' end group by v.G_ID ,G.Group_name ,v.xe_");
                rpt.SetDataSource(dt_);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                "%' and isnull(C.LC_ACC_NO,'') like '" + Lc_Acc.ID.Text +
                "%'	and A.Item_No  like '" + UcItem.ID.Text +
                "%' and isnull(C.Po_no,'') like case when '" + txtPoNo.Text.Trim() + "'='' then '%' else '" + txtPoNo.Text + "' end group by v.G_ID,G.Group_name,p.Payment_name");
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_ = dal.getDataTabl_1(@"SELECT d.ITEM_NO,s.descr,s.UnitDepth,s.group_code,s.Dim_category,s.Category
                ...
                "%'	and S.Item_No  like '" + UcItem.ID.Text +
                "%' and isnull(A.Po_no,'') like case when '" + txtPoNo.Text.Trim() + "'='' then '%' else '" + txtPoNo.Text + "' end" +
  ...
  FROM  wh_material_transaction As D
		...
		inner join wh_Payment_type As P on p.Payment_type=c.Payment_Type
                ...
                "and isnull(C.LC_ACC_NO,'') like '" + Lc_Acc.ID.Text +
                "%'	and A.Item_No  like '" + UcItem.ID.Text +
                "%' and isnull(C.Po_no,'') like case when '" + txtPoNo.Text.Trim() + "'='' then '%' else '" + txtPoNo.Text + "' end GROUP BY FORMAT(C.g_date, 'MM-yyyy') ");
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            "%' and isnull(C.LC_ACC_NO,'') like '" + Lc_Acc.ID.Text +
            "%'	and A.Item_No  like '" + UcItem.ID.Text +
            "%' and isnull(C.Po_no,'') like case when '" + txtPoNo.Text.Trim() + "'='' then '%' else '" + txtPoNo.Text + "' end group by C.acc_no, P.PAYER_NAME");
 ...
 where D.TRANSACTION_CODE like 'xp%'
                ...
                "%' and isnull(A.LC_ACC_NO,'') like '" + Lc_Acc.ID.Text +
                "%'	and S.Item_No  like '" + UcItem.ID.Text +
                "%' and isnull(A.Po_no,'') like case when '" + txtPoNo.Text.Trim() + "'='' then '%' else '" + txtPoNo.Text + "' end group by   A.Ser_no,B.branch_name,A.G_date,p.PAYER_NAME, A.Inv_no, A.Inv_date, p.COSTMER_K_M_NO, A.Transaction_code, A.Branch_code," +
